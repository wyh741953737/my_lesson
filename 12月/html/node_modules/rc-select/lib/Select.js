...
var Select = function (_React$Component) {
    ...
    function Select(props) {
        ...
        _this.getOptionInfoBySingleValue = function (value, optionsInfo) {
            ...
            var defaultInfo = {
                option: React.createElement(_Option2['default'], { value: value, key: value }, value),
                value: value,
                label: defaultLabel
            };
            return defaultInfo;
        ...
        _this.getPlaceholderElement = function () {
            ...
            if (placeholder) {
                return React.createElement("div", (0, _extends3['default'])({ onMouseDown: _util.preventDefaultEvent, style: (0, _extends3['default'])({ display: hidden ? 'none' : 'block' }, _util.UNSELECTABLE_STYLE) }, _util.UNSELECTABLE_ATTRIBUTE, { onClick: _this.onPlaceholderClick, className: props.prefixCls + '-selection__placeholder' }), placeholder);
            }
            return null;
        };
        _this.getInputElement = function () {
            var props = _this.props;
            var defaultInput = React.createElement("input", { id: props.id, autoComplete: "off" });
            ...
            return React.createElement("div", { className: props.prefixCls + '-search__field__wrap' }, React.cloneElement(inputElement, {
                ...
                className: inputCls
            }), React.createElement("span", { ref: _this.saveInputMirrorRef, className: props.prefixCls + '-search__field__mirror' }, _this.state.inputValue, '\xA0'));
        };
        ...
        _this.setOpenState = function (open, needFocus) {
            ...
            _this.setState((0, _extends3['default'])({ open: open }, nextState), function () {
                if (open) {
                    _this.maybeFocus(open, !!needFocus);
                }
            });
        ...
        _this.filterOption = function (input, child) {
            ...
            if ('filterOption' in _this.props) {
                if (filterFn === true) {
                    filterFn = defaultFilter.bind(_this);
                }
            } else {
                filterFn = defaultFilter.bind(_this);
            }
            if (!filterFn) {
                ...
                return filterFn.call(_this, input, child);
        ...
        _this.isChildDisabled = function (key) {
            return (0, _toArray2['default'])(_this.props.children).some(function (child) {
        ...
        _this.renderFilterOptions = function () {
            ...
            if (tags) {
                ...
                value.forEach(function (singleValue) {
                    var key = singleValue;
                    var menuItem = React.createElement(_rcMenu.Item, { style: _util.UNSELECTABLE_STYLE, role: "option", attribute: _util.UNSELECTABLE_ATTRIBUTE, value: key, key: key }, key);
                ...
                if (inputValue) {
                    var notFindInputItem = menuItems.every(function (option) {
                        ...
                        if (filterOption !== false) {
                            return !_this.filterOption.call(_this, inputValue, option, filterFn);
                        }
                        return !filterFn();
                    });
                    if (notFindInputItem) {
                        options.unshift(React.createElement(_rcMenu.Item, { style: _util.UNSELECTABLE_STYLE, role: "option", attribute: _util.UNSELECTABLE_ATTRIBUTE, value: inputValue, key: inputValue }, inputValue));
                    }
                }
            }
            if (!options.length && notFoundContent) {
                options = [React.createElement(_rcMenu.Item, { style: _util.UNSELECTABLE_STYLE, attribute: _util.UNSELECTABLE_ATTRIBUTE, disabled: true, role: "option", value: "NOT_FOUND", key: "NOT_FOUND" }, notFoundContent)];
            }
            return options;
        };
                ...
                if (type.isSelectOptGroup) {
                    ...
                    if (inputValue && _this.filterOption(inputValue, child)) {
                        var innerItems = (0, _toArray2['default'])(child.props.children).map(function (subChild) {
                            ...
                            return React.createElement(_rcMenu.Item, (0, _extends3['default'])({ key: childValueSub, value: childValueSub }, subChild.props));
                        });
                        sel.push(React.createElement(_rcMenu.ItemGroup, { key: key, title: label }, innerItems));
                        // Not match
                    } else {
                        var _innerItems = _this.renderFilterOptionsFromChildren(child.props.children, childrenKeys, menuItems);
                        if (_innerItems.length) {
                            sel.push(React.createElement(_rcMenu.ItemGroup, { key: key, title: label }, _innerItems));
                        }
                    }
                    return;
                }
                (0, _warning2['default'])(type.isSelectOption, 'the children of `Select` should be `Select.Option` or `Select.OptGroup`, ' + ('instead of `' + (type.name || type.displayName || child.type) + '`.'));
                var childValue = (0, _util.getValuePropValue)(child);
                (0, _util.validateOptionValue)(childValue, _this.props);
                if (_this.filterOption(inputValue, child)) {
                    var menuItem = React.createElement(_rcMenu.Item, (0, _extends3['default'])({ style: _util.UNSELECTABLE_STYLE, attribute: _util.UNSELECTABLE_ATTRIBUTE, value: childValue, key: childValue, role: "option" }, child.props));
                    sel.push(menuItem);
                    menuItems.push(menuItem);
                }
                if (tags) {
        ...
        _this.renderTopControlNode = function () {
            ...
            if ((0, _util.isSingleMode)(props)) {
                ...
                if (value.length) {
                    ...
                    selectedValue = React.createElement("div", { key: "value", className: prefixCls + '-selection-selected-value', title: (0, _util.toTitle)(title || label), style: {
                ...
                if (!showSearch) {
                    ...
                    innerNode = [selectedValue, React.createElement("div", { className: prefixCls + '-search ' + prefixCls + '-search--inline', key: "input", style: {
                ...
                if (maxTagCount !== undefined && value.length > maxTagCount) {
                    ...
                    maxTagPlaceholderEl = React.createElement("li", (0, _extends3['default'])({ style: _util.UNSELECTABLE_STYLE }, _util.UNSELECTABLE_ATTRIBUTE, { role: "presentation", onMouseDown: _util.preventDefaultEvent, className: prefixCls + '-selection__choice ' + prefixCls + '-selection__choice__disabled', key: "maxTagPlaceholder", title: (0, _util.toTitle)(content) }), React.createElement("div", { className: prefixCls + '-selection__choice__content' }, content));
                }
                if ((0, _util.isMultipleOrTags)(props)) {
                    selectedValueNodes = limitedCountValue.map(function (singleValue) {
                        ...
                        return React.createElement("li", (0, _extends3['default'])({ style: _util.UNSELECTABLE_STYLE }, _util.UNSELECTABLE_ATTRIBUTE, { onMouseDown: _util.preventDefaultEvent, className: choiceClassName, role: "presentation", key: singleValue || SELECT_EMPTY_VALUE_KEY, title: (0, _util.toTitle)(title) }), React.createElement("div", { className: prefixCls + '-selection__choice__content' }, content), disabled ? null : React.createElement("span", { onClick: function onClick(event) {
                                _this.removeSelected(singleValue, event);
                            }, className: prefixCls + '-selection__choice__remove' }, removeIcon || React.createElement("i", { className: prefixCls + '-selection__choice__remove-icon' }, '\xD7')));
                    });
                }
                if (maxTagPlaceholderEl) {
                    selectedValueNodes.push(maxTagPlaceholderEl);
                }
                selectedValueNodes.push(React.createElement("li", { className: prefixCls + '-search ' + prefixCls + '-search--inline', key: "__input" }, _this.getInputElement()));
                if ((0, _util.isMultipleOrTags)(props) && choiceTransitionName) {
                    innerNode = React.createElement(_rcAnimate2['default'], { onLeave: _this.onChoiceAnimationLeave, component: "ul", transitionName: choiceTransitionName }, selectedValueNodes);
                } else {
                    innerNode = React.createElement("ul", null, selectedValueNodes);
                }
            }
            return React.createElement("div", { className: className, ref: _this.saveTopCtrlRef }, _this.getPlaceholderElement(), innerNode);
        };
        ...
        _this.ariaId = (0, _util.generateUUID)();
        return _this;
    }
    ...
    (0, _createClass3['default'])(Select, [{
        ...
        value: function renderArrow(multiple) {
            ...
            return React.createElement("span", (0, _extends3['default'])({ key: "arrow", className: prefixCls + '-arrow', style: _util.UNSELECTABLE_STYLE }, _util.UNSELECTABLE_ATTRIBUTE, { onClick: this.onArrowClick }), inputIcon || defaultIcon);
        }
    }, {
        key: 'renderClear',
        value: function renderClear() {
            ...
            var clear = React.createElement("span", (0, _extends3['default'])({ key: "clear", className: prefixCls + '-selection__clear', onMouseDown: _util.preventDefaultEvent, style: _util.UNSELECTABLE_STYLE }, _util.UNSELECTABLE_ATTRIBUTE, { onClick: this.onClearSelection }), clearIcon || React.createElement("i", { className: prefixCls + '-selection__clear-icon' }, '\xD7'));
            if (!allowClear) {
                return null;
            }
        ...
        value: function render() {
            ...
            if (!(0, _util.isMultipleOrTagsOrCombobox)(props)) {
                extraSelectionProps = (0, _extends3['default'])({}, extraSelectionProps, { onKeyDown: this.onKeyDown, tabIndex: props.disabled ? -1 : props.tabIndex });
            }
            ...
            return React.createElement(_SelectTrigger2['default'], { onPopupFocus: this.onPopupFocus, onMouseEnter: this.props.onMouseEnter, onMouseLeave: this.props.onMouseLeave, dropdownAlign: props.dropdownAlign, dropdownClassName: props.dropdownClassName, dropdownMatchSelectWidth: props.dropdownMatchSelectWidth, defaultActiveFirstOption: props.defaultActiveFirstOption, dropdownMenuStyle: props.dropdownMenuStyle, transitionName: props.transitionName, animation: props.animation, prefixCls: props.prefixCls, dropdownStyle: props.dropdownStyle, combobox: props.combobox, showSearch: props.showSearch, options: options, multiple: multiple, disabled: disabled, visible: realOpen, inputValue: state.inputValue, value: state.value, backfillValue: state.backfillValue, firstActiveValue: props.firstActiveValue, onDropdownVisibleChange: this.onDropdownVisibleChange, getPopupContainer: props.getPopupContainer, onMenuSelect: this.onMenuSelect, onMenuDeselect: this.onMenuDeselect, onPopupScroll: props.onPopupScroll, showAction: props.showAction, ref: this.saveSelectTriggerRef, menuItemSelectedIcon: props.menuItemSelectedIcon, dropdownRender: props.dropdownRender, ariaId: this.ariaId }, React.createElement("div", { id: props.id, style: props.style, ref: this.saveRootRef, onBlur: this.onOuterBlur, onFocus: this.onOuterFocus, className: (0, _classnames3['default'])(rootCls), onMouseDown: this.markMouseDown, onMouseUp: this.markMouseLeave, onMouseOut: this.markMouseLeave }, React.createElement("div", (0, _extends3['default'])({ ref: this.saveSelectionRef, key: "selection", className: prefixCls + '-selection\n            ' + prefixCls + '-selection--' + (multiple ? 'multiple' : 'single'), role: "combobox", "aria-autocomplete": "list", "aria-haspopup": "true", "aria-controls": this.ariaId, "aria-expanded": realOpen }, extraSelectionProps), ctrlNode, this.renderClear(), this.renderArrow(!!multiple))));
        }
    }]);
    return Select;
}(React.Component);
