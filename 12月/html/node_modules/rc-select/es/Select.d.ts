...
declare class Select extends React.Component<Partial<ISelectProps>, ISelectState> {
    static propTypes: {
        ...
        value: (props: ISelectProps, propName: string, componentName: string) => Error | null;
        defaultValue: (props: ISelectProps, propName: string, componentName: string) => Error | null;
    ...
    onArrowClick: (e: React.MouseEvent<HTMLIFrameElement>) => void;
    ...
    removeSelected: (selectedKey: string | string[], e?: React.MouseEvent<HTMLSpanElement> | undefined) => void;
