...
var Select = function (_React$Component) {
    ...
    function Select(props) {
        ...
        _this.getOptionInfoBySingleValue = function (value, optionsInfo) {
            ...
            var defaultInfo = {
                option: React.createElement(Option, { value: value, key: value }, value),
                value: value,
                label: defaultLabel
            };
            return defaultInfo;
        ...
        _this.getPlaceholderElement = function () {
            ...
            if (placeholder) {
                return React.createElement("div", _extends({ onMouseDown: preventDefaultEvent, style: _extends({ display: hidden ? 'none' : 'block' }, UNSELECTABLE_STYLE) }, UNSELECTABLE_ATTRIBUTE, { onClick: _this.onPlaceholderClick, className: props.prefixCls + '-selection__placeholder' }), placeholder);
            }
            return null;
        };
        ...
        _this.setOpenState = function (open, needFocus) {
            ...
            _this.setState(_extends({ open: open }, nextState), function () {
                if (open) {
                    _this.maybeFocus(open, !!needFocus);
                }
            });
        ...
        _this.renderFilterOptions = function () {
            ...
            if (tags) {
                ...
                value.forEach(function (singleValue) {
                    var key = singleValue;
                    var menuItem = React.createElement(MenuItem, { style: UNSELECTABLE_STYLE, role: "option", attribute: UNSELECTABLE_ATTRIBUTE, value: key, key: key }, key);
                ...
                if (inputValue) {
                    ...
                    if (notFindInputItem) {
                        options.unshift(React.createElement(MenuItem, { style: UNSELECTABLE_STYLE, role: "option", attribute: UNSELECTABLE_ATTRIBUTE, value: inputValue, key: inputValue }, inputValue));
                    }
                }
            }
            if (!options.length && notFoundContent) {
                options = [React.createElement(MenuItem, { style: UNSELECTABLE_STYLE, attribute: UNSELECTABLE_ATTRIBUTE, disabled: true, role: "option", value: "NOT_FOUND", key: "NOT_FOUND" }, notFoundContent)];
            }
            return options;
        };
                ...
                if (type.isSelectOptGroup) {
                    ...
                    if (inputValue && _this.filterOption(inputValue, child)) {
                        var innerItems = childrenToArray(child.props.children).map(function (subChild) {
                            ...
                            return React.createElement(MenuItem, _extends({ key: childValueSub, value: childValueSub }, subChild.props));
                        });
                        ...
                        if (_innerItems.length) {
                            sel.push(React.createElement(MenuItemGroup, { key: key, title: label }, _innerItems));
                        }
                    }
                    return;
                }
                warning(type.isSelectOption, 'the children of `Select` should be `Select.Option` or `Select.OptGroup`, ' + ('instead of `' + (type.name || type.displayName || child.type) + '`.'));
                var childValue = getValuePropValue(child);
                validateOptionValue(childValue, _this.props);
                if (_this.filterOption(inputValue, child)) {
                    var menuItem = React.createElement(MenuItem, _extends({ style: UNSELECTABLE_STYLE, attribute: UNSELECTABLE_ATTRIBUTE, value: childValue, key: childValue, role: "option" }, child.props));
                    sel.push(menuItem);
                    menuItems.push(menuItem);
                }
                if (tags) {
        ...
        _this.renderTopControlNode = function () {
            ...
            if (isSingleMode(props)) {
                ...
                if (value.length) {
                    ...
                    selectedValue = React.createElement("div", { key: "value", className: prefixCls + '-selection-selected-value', title: toTitle(title || label), style: {
                ...
                if (maxTagCount !== undefined && value.length > maxTagCount) {
                    ...
                    maxTagPlaceholderEl = React.createElement("li", _extends({ style: UNSELECTABLE_STYLE }, UNSELECTABLE_ATTRIBUTE, { role: "presentation", onMouseDown: preventDefaultEvent, className: prefixCls + '-selection__choice ' + prefixCls + '-selection__choice__disabled', key: "maxTagPlaceholder", title: toTitle(content) }), React.createElement("div", { className: prefixCls + '-selection__choice__content' }, content));
                }
                if (isMultipleOrTags(props)) {
                ...
                if (isMultipleOrTags(props) && choiceTransitionName) {
                    innerNode = React.createElement(Animate, { onLeave: _this.onChoiceAnimationLeave, component: "ul", transitionName: choiceTransitionName }, selectedValueNodes);
                } else {
    ...
    _createClass(Select, [{
        ...
        value: function renderArrow(multiple) {
            ...
            return React.createElement("span", _extends({ key: "arrow", className: prefixCls + '-arrow', style: UNSELECTABLE_STYLE }, UNSELECTABLE_ATTRIBUTE, { onClick: this.onArrowClick }), inputIcon || defaultIcon);
        }
    }, {
        key: 'renderClear',
        value: function renderClear() {
            ...
            var clear = React.createElement("span", _extends({ key: "clear", className: prefixCls + '-selection__clear', onMouseDown: preventDefaultEvent, style: UNSELECTABLE_STYLE }, UNSELECTABLE_ATTRIBUTE, { onClick: this.onClearSelection }), clearIcon || React.createElement("i", { className: prefixCls + '-selection__clear-icon' }, '\xD7'));
            if (!allowClear) {
                return null;
            }
        ...
        value: function render() {
            ...
            if (!isMultipleOrTagsOrCombobox(props)) {
                extraSelectionProps = _extends({}, extraSelectionProps, { onKeyDown: this.onKeyDown, tabIndex: props.disabled ? -1 : props.tabIndex });
            }
